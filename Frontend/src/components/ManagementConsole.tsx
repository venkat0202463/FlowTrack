        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="bg-[#eff6ff] px-4 py-2 rounded-full border border-[#dbeafe]">
            <span className="text-xs font-bold text-[#1d4ed8] flex items-center gap-2">
              <ShieldCheck size={14} /> Active Manager Session
            </span>
          </div>
        </div>
      </header>
            ...
            <div className="bg-white p-8 rounded-[24px] border border-[#e2e8f0] shadow-sm sticky top-0">
              ...
              <form onSubmit={handleOnboard} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-[#0052CC] text-white rounded-xl text-sm font-black uppercase tracking-widest shadow-xl shadow-[#0052CC]/20 hover:bg-[#0747A6] hover:scale-[1.02] transition-all disabled:opacity-50 disabled:scale-100 flex items-center justify-center gap-3"
                >
                  <UserPlus size={18} />
                  ...
                  <tbody className="divide-y divide-[#f1f5f9]">
                    {users.map(u => (
                      <tr key={u.id} className="hover:bg-[#f8fafc] transition-colors group">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black tracking-wider ${u.role === 'MANAGER' ? 'bg-[#fff7ed] text-[#c2410c]' : 'bg-[#f0f9ff] text-[#0369a1]'}`}>
                            {u.role}
                          </span>
                        </td>
                        <td className="px-6 py-4">
